...
@Test
    ...
    public void verifyGetSimilarBooks() {
        ...
        List<String> listOfBooks = response.jsonPath().get("category");
    ...
    public void addBookToShoppingCart(int bookId) {
        ...
        log.info(books[0].getQuantity());
        log.info(books[0].getBook().getAuthor());
        log.info(books[0].getBook().getTitle());
        log.info(books[0].getBook().getPrice());
